...
plugins.factory('userPlugins', ['$http', function($http) {
    ...
    return {
        plugins: [youtubePlugin, dailymotionPlugin, allocinePlugin, imagePlugin, spotifyPlugin, cloudmusicPlugin, googlemapPlugin, asciinemaPlugin, yrPlugin, gistPlugin, imgurPlugin, tweetPlugin, deviantartPlugin]
    };
